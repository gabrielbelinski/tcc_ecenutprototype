                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr
                                    v-for="paciente in page.props.pacientes"
                                    :key="paciente.id"
                                >
                                    ...
                                    >
                                        <Link
                                            :href="`/paciente/${paciente.id}/edit/`"
                                ...
                                <tr v-if="page.props.pacientes.length === 0">
                                    <td
                                        colspan="6"
...
const totalPages = computed(() => {
    return Math.ceil(page.props.pacientes.length / perPage.value);
});

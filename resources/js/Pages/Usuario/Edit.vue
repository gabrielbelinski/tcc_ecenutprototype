...
const form = useForm({
    email: page.props.usuario.email,
    matricula: page.props.usuario.matricula,
    genero: page.props.usuario.genero,
    data_nascimento: page.props.usuario.data_nascimento,
    nome: page.props.usuario.nome,
    telefone: page.props.usuario.telefone,
    rg: page.props.usuario.rg,
    cpf: page.props.usuario.cpf,
    rua: page.props.usuario.rua,
    numero: page.props.usuario.numero,
    bairro: page.props.usuario.bairro,
    cep: page.props.usuario.cep,
    cidade: page.props.usuario.cidade,
    estado: page.props.usuario.estado,
    tipo_usuario: page.props.usuario.tipo_usuario,
});
...
const update = () => {
    form.put(`/usuario/${page.props.usuario.id}`);
};
</script>

/**
  ...
  *
  * @checksum - 3497f37b37bf0bc236f94943a39e661986685809bd0c3c4e2bd3e4516bb5291c
  * @variables - radius=rounded-xl,accentColor=green,colorTemperature=neutral,spacing=2,scale=sm,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=300,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-neutral-400": true
  },
  ...
  "color__inner": {
    ...
    "dark:group-data-[prefix-icon]:border-neutral-300": true,
    "dark:group-data-[suffix-icon]:border-neutral-300": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "dark:[&::-webkit-slider-runnable-track]:bg-neutral-400/50": true,
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-neutral-500": true,
    ...
    "dark:[&::-moz-range-track]:bg-neutral-400/50": true,
  ...
  "submit__input": {
    ...
    "group-data-[loading=true]/form:before:w-full": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-neutral-300": true,
  ...
  "slider__minValue": {
    ...
    "dark:[&>div>div::after]:bg-neutral-300": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "dark:ring-neutral-500": true,
    "dark:data-[is-active=true]:ring-green-500": true,
    "dark:aria-selected:ring-green-500": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-neutral-400": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=progress]/wrapper:before:border-neutral-400": true,
    ...
    "dark:group-data-[tab-style=progress]/wrapper:after:bg-neutral-400": true,

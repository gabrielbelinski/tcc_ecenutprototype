/**
  ...
  *
  * @checksum - 3b458b6b43cc016f4d747b041da26b9d89ca3917e49821be00ff35bff43c9969
  * @variables - radius=rounded-full,accentColor=green,colorTemperature=neutral,spacing=2.5,scale=lg,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const globals = {
  "outer": {
    ...
    "mb-4": true,
    "data-[disabled]:select-none": true,
    "data-[disabled]:opacity-25": false,
    "text-lg": true
  },
  "label": {
    "block": true,
